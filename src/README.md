...
- **`pipeline/`** — Multi-pass render pipeline. Entry: `MultiPassPipeline` from `./pipeline`. Contains `passes/` (Intensity, FlowPattern, Blur, BlinnPhong, Compositor) and `utils/` (fullscreen quad, scene clone helpers).

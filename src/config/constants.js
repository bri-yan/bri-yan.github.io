...
export const DEFAULT_FLOW_PATTERN_THRESHOLD = 0.5; // 0.5 - 0.6
...
export const DEFAULT_BLINN_PHONG_AMBIENT_STRENGTH = 0.3;
export const DEFAULT_BLINN_PHONG_DIFFUSE_STRENGTH = 0.7;
